# BackEnd/app/data_access/profiling/contribution_reputation_repository.py
# -*- coding: utf-8 -*-
...
class ContributionReputationRepository(MongoDBBaseRepository):
    """
    ...
    def __init__(
        ...
        """
        Args:
            batch_size: Mongo 游标 batch_size（逻辑参数，目前基于 aggregate 读取）。
    ...
    # ------------------------------------------------------------------
    # 内部：Mongo 访问 & 课程发现（基于 MongoDBBaseRepository.aggregate）
    # ------------------------------------------------------------------
    ...
    def _aggregate_value_metrics_for_courses(
        ...
        for stats in value_stats_by_lc.values():
